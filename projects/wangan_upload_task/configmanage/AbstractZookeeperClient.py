...
def test():
    ...
    zk = AbstractZookeeperClient(logger=logger)
    zk.create_path('/conf/test-serv/')
    zk.create_node('/conf/test-serv/zookeeper.connection.timeout.ms/','2000')
    #print zk.get_kvmap_byparent('/conf/test')
    #print zk.get_kvlist_byparent('/conf/test')
    #print zk.getdata('/conf/test/')
    #zk.create_path('/conf/test/')
    #print zk._is_connected()
    zk._close()
